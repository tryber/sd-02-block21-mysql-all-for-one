# Requisito 7- Faça uma consulta que retorne três colunas. Na primeira coluna, exiba a soma de 5 + 6 
# (essa soma deve ser realizada pelo SQL). Na segunda coluna deve haver a palavra "de". E por fim, na terceira coluna, exiba a soma de 2 + 8 
